...
namespace TilausDBAdvancedMVCPalautus.Controllers
{
    public class TuotteetController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TuoteID,Nimi,Ahinta,Kuva,ImageLink,KategoriaID")] Tuotteet tuotteet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TuoteID,Nimi,Ahinta,Kuva,ImageLink,KategoriaID")] Tuotteet tuotteet)
        {
            if (ModelState.IsValid)
            {
