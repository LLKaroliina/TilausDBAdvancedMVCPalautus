...
namespace TilausDBAdvancedMVCPalautus.Controllers
{
    public class TilausrivitController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TilausriviID,TuoteID,Maara,Ahinta,TilausID")] Tilausrivit tilausrivit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TilausriviID,TuoteID,Maara,Ahinta,TilausID")] Tilausrivit tilausrivit)
        {
            if (ModelState.IsValid)
            {
